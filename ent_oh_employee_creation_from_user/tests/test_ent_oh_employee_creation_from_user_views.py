...
@tagged("-at_install", "post_install", "ent_oh_employee_creation_from_user")
class TestEntOhEmployeeCreationFromUserViews(TransactionCase):
    """Automated smoke test - ensures views load without errors."""

    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        _module = "ent_oh_employee_creation_from_user"
