...
class GratuityConfiguration(models.Model):
    ...
    percentage = fields.Float(default=1, string="Percentage",
                              help="Gratuity payment percentage")
