...
@tagged("-at_install", "post_install", "ent_hr_leave_request_aliasing")
class TestEntHrLeaveRequestAliasingViews(TransactionCase):
    """Automated smoke test - ensures views load without errors."""

    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        _module = "ent_hr_leave_request_aliasing"
