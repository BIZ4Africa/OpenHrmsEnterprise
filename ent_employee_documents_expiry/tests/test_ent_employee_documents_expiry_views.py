...
@tagged("-at_install", "post_install", "ent_employee_documents_expiry")
class TestEntEmployeeDocumentsExpiryViews(TransactionCase):
    """Automated smoke test - ensures views load without errors."""

    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        _module = "ent_employee_documents_expiry"
